...
const char input[] = "Cabspotting.txt";
const char output[] = "Cabspotting2days.txt";

const unsigned long long int minValidTime = 1036800;
const unsigned long long int maxValidTime = 1209600;
