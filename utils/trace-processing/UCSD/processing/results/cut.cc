...
const char input[] = "UCSD.txt";
const char output[] = "UCSD3weeks.txt";

const unsigned long long int minValidTime = 345600;
const unsigned long long int maxValidTime = 2160000;
