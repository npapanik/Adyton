...
# How it works |
#---------------
# Step 1: Clean the dataset. Remove all external noise that is the set of devices with ID larger than 41.
# 
...
NN=41;
final=./Infocom05.txt;
input=../original/Exp3/contacts.Exp3.dat;
summary=./summary.txt;
arrival=./Infocom05-presence.txt;
temp=./tmp.txt;
active=./active-nodes.txt;
inactive=./inactive-nodes.txt;
dups=./Infocom05-before-dups-removed.txt
rm -rf ${final};
rm -rf ${summary};
rm -rf ${arrival};
rm -rf ${temp};
