...
class Optimal: public Routing
{
public:
	Optimal(PacketPool* PP, MAC* mc, PacketBuffer* Bf, int NID, Statistics *St, Settings *S, God *G);
	~Optimal();
...
private:
	...
	void ReceptionEnhancedSummary(Header *hd, Packet *pkt, int PID, double CurrentTime);
